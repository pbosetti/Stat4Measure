...
In questo caso i dati vengono generati dalla funzione passata come argomento `ran.gen`, che accetta due parametri: il primo è il vettore di dati originali e il secondo è l'oggetto opzionalmente passato all'aromento `mle`. Nel nostro caso, passiamo a `mle` una lista con la media e la deviazione standard campionarie.
```{r fig.margin=T}
set.seed(1)
data <- rbeta(100, 1, 10)
